                    ...
                    <div key={ct.id} className={styles.insCard}>
                      <div className={styles.insCardHeader}>
                        <div className={styles.insCardLeft}>
                          <div className={styles.insCardTitle}>
                        ...
                        <div className={styles.contractEditBox}>
                          <div className={styles.editGrid}>
                            {[
                              ...
                              { key: 'monthly_fee', label: '월보험료' },
                              { key: 'insurance_type', label: '보험종류' },
                              { key: 'contract_start', label: '가입연월' },
                              { key: 'payment_years', label: '납입기간' },
                              { key: 'expiry_age', label: '만기' },
                              { key: 'payment_status', label: '납입상태' },
                            ].map(f => (
                              <div key={f.key} className={styles.editField}>
                                <label>{f.label}</label>
                        ...
                        <div className={styles.coverageList}>
                          {groups.map(g => (
                            <div key={g.key} className={styles.coverageRow}>
                              ...
                              <span className={styles.covVal}>
                                {g.items.map(cv => `${cv.coverage_name} ${fmtAmount(cv.amount)}`).join(' / ')}
                              </span>
                            </div>
                          ))}
                        </div>
